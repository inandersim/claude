...
## 1. Bugünkü durum (v1.6)

| Katman                     | Durum                                                                                                                                      | Üretimde ne gerekir                                                                                                |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| Uygulama (Expo/RN)         | ✅ Gerçek. iOS/Android/Web tek kod; typed routes; tasarım sistemi; 23 dil (RTL dahil); ortam ışığına göre tema; erişilebilirlik etiketleri | EAS Build + OTA (`eas.json` hazır), Sentry, analitik                                                               |
...
| Test & CI                  | ✅ 700+ Jest + pipeline testi; güvenlik taramaları (gitleaks, audit, CodeQL, Semgrep); GitHub Actions (lint, typecheck, test, web export)  | E2E (Maestro/Detox), görsel regresyon                                                                              |
